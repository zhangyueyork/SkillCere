...
SkillCere（技能小脑）是一个跨 Agent 的技能协调系统，用于持续发现、登记和更新各平台 skill，并在任务开始前根据需求推荐最合适的平台、skill 组合和启动说明。

核心隐喻：

```text
Agent 是大脑，负责理解、推理和执行。
SkillCere 是小脑，负责协调 skill、平台、版本和任务启动动作，让执行更顺滑。
```
...
├── platforms.json            # 平台特性配置，不含本机真实路径
